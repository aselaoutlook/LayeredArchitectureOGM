...
namespace FCL.Web.Framework.Core.RazorExtentions
{
    ...
    public class TableBuilder<TModel> : ITableBuilder<TModel> where TModel : class
    {
        ...
        /// Set the table's id.
        /// </summary>
        /// <param name="id">name/id of the table</param>
        /// <returns>Reference to the TableBuilder object.</returns>
        public TableBuilder<TModel> TableId(string id)
        {
            this.Id = id;
            return this;
        }
        ...
        /// <summary>
        /// Set a list of classes to tabe
        /// </summary>
        /// <param name="classNames">List of classes seperated by space</param>
        /// <returns>Reference to the TableBuilder object.</returns>
        public TableBuilder<TModel> ClassList(string classNames)
        {
        ...
        public MvcHtmlString ToHtml()
        {
            ...
            foreach (var tc in this.TableColumns)
            {
